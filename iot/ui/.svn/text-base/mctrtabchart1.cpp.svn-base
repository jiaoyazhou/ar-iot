...
mctrtabchart1::mctrtabchart1(QWidget *parent)
       : QWidget(parent),
		 m_iLine(10),
		 m_iDecValue(10),
		 m_iMax(m_iLine*m_iDecValue)
{
	m_Palette.setColor(QPalette::Text,QColor(Qt::black));
	this->setPalette(m_Palette);
	this->initVariables();
}

mctrtabchart1::~mctrtabchart1() {
	// TODO Auto-generated destructor stub
}

void mctrtabchart1::initVariables()
{
...
void mctrtabchart1::paintEvent(QPaintEvent *e)
{
    QPainter painter;
    painter.begin(this);
...
void mctrtabchart1::resetVariables(QPainter *painter)
{
...
void mctrtabchart1::drawBackground(QPainter *painter)
{
    painter->save();
...
void mctrtabchart1::drawBox(QPainter *painter)
{
    painter->save();
    ...
    if(m_bShowHLine)
    {
        ...
        qreal increment=(qreal)m_boxRect.height()/m_iLine;
...
void mctrtabchart1::drawText1(QPainter *painter)
{
    painter->save();
...
void mctrtabchart1::drawText2(QPainter *painter)
{
    painter->save();
...
void mctrtabchart1::drawGraph(QPainter *painter)
{
    painter->save();
...
void mctrtabchart1::drawTitle(QPainter *painter)
{
    painter->save();
...
void mctrtabchart1::addData(qreal data)
{
    m_dataVec.push_front(data);
    updateVector();
}

void mctrtabchart1::updateVector()
{
